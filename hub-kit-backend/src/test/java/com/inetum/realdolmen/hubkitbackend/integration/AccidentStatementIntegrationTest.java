...
public class AccidentStatementIntegrationTest {
    ...
    @Test
    public void createStatementWithNullPolicyHolderGreenCardNumberTest() throws JsonProcessingException {
        // JSON body with a policyholder that has an empty green card number

        policyHolderVehicleA.getInsuranceCertificates().getFirst().setGreenCardNumber(null);
    ...
    @Test
    public void createStatementWithNullPolicyHolderPolicyNumberTest() throws JsonProcessingException {
        // JSON body with a policyholder that has an empty policy number

        policyHolderVehicleA.getInsuranceCertificates().getFirst().setPolicyNumber(null);
