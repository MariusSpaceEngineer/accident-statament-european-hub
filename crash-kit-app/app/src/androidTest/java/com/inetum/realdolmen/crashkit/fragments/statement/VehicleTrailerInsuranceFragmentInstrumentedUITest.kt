...
import com.inetum.realdolmen.crashkit.fragments.statement.vehicle_a.VehicleATrailerInsuranceFragment
...
class VehicleTrailerInsuranceFragmentInstrumentedUITest {
    ...
    fun setup() {
        ...
        launchFragmentInContainer<VehicleATrailerInsuranceFragment>(themeResId = R.style.Theme_CrashKit) {
            VehicleATrailerInsuranceFragment().also { fragment ->
    ...
    @Test
    fun testVehicleTrailerInsuranceUIElements() {
        // Check to see if the fields are displayed on the screen
        onView(withId(R.id.et_statement_vehicle_a_trailer_insurance_company_name))
            .check(matches(isDisplayed()))
        onView(withId(R.id.et_statement_vehicle_a_trailer_insurance_company_policy_number))
            .check(matches(isDisplayed()))
        onView(withId(R.id.et_statement_vehicle_a_trailer_insurance_company_certificate_expiration_date))
            .check(matches(isDisplayed()))
        onView(withId(R.id.et_statement_vehicle_a_trailer_insurance_company_certificate_availability_date))
            .check(
                matches(
                    isDisplayed()
                )
        ...
        onView(withId(R.id.et_statement_vehicle_a_trailer_insurance_company_certificate_availability_date)).check(
            matches(not(isEnabled()))
        )
        onView(withId(R.id.et_statement_vehicle_a_trailer_insurance_company_certificate_expiration_date)).check(
            matches(not(isEnabled()))
        )

        onView(withId(R.id.et_statement_vehicle_a_trailer_insurance_agency_email))
            .perform(scrollTo())
            .check(
                matches(
                    isDisplayed()
        ...
        onView(withId(R.id.et_statement_vehicle_a_trailer_insurance_agency_name))
            .check(
                matches(
                    isDisplayed()
                )
            )
        onView(withId(R.id.et_statement_vehicle_a_trailer_insurance_agency_address))
            .check(
                matches(
                    isDisplayed()
                )
            )
        onView(withId(R.id.et_statement_vehicle_a_trailer_insurance_agency_country))
            .check(
                matches(
                    isDisplayed()
                )
        ...
        onView(withId(R.id.et_statement_vehicle_a_trailer_insurance_agency_phone_number))
            .check(
                matches(
                    isDisplayed()
                )
